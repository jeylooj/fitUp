...
export default function BlogPost() {
  return (
    ...
    <div className="flex justify-content-between h-auto  lg:flex-row px-5">
      <section className=" w-100 w-lg-50">
     <h1 className="px-5 my-2 bg-secondary text-white text-center">title</h1>
      <p className=" text-white p-5 ">Transforming your body is more than just a physical change; it's a mental and emotional one as well. A fitness journey is a process of self-discovery and growth. Whether you're looking to lose weight, gain muscle, improve your health, or simply feel better about yourself, the journey of transforming your body is a holistic one that involves your mind, body, and emotions.
