  ...
  return (
    ...
    <div className="p-10 flex justify-between flex-col lg:flex-row">
     ...
     <h1 className="px-5 bg-secondary cus-font text-white text-center h-14 flex align-middle justify-center items-center">TITLE POST :{id}</h1>
      ...
      Transforming your body also involves emotional growth. It requires addressing and working through any emotional barriers or negative self-talk that may have held you back in the past. 
      </p>
    </section>
